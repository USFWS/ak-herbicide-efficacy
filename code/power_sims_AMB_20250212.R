...
#Run simulation
poisson.power.1cov<-function(alpha=0.10,nsims=NULL,n0=NULL,n1=NULL, covariate=NULL, B0=NULL, B1=NULL, possible.effects=NULL )
{
...
powers<-poisson.power.1cov(alpha =alpha,n0 = n0,n1 = n1,nsims = nsims,covariate = Y0, B0 =B0, B1 = B1, possible.effects = effects)
...
ggsave("C:/Users/AMBenson/OneDrive - DOI/Documents/InvasiveSpecies/SouthernAlaska/2025_Sampling/PowerSimResults_n120120_20250218.jpg",
       n120120,
       width = 4, 
       height = 4)
